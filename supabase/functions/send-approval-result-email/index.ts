...
serve(async (req) => {
  ...
  try {
    ...
    const decisionColor =
      approval_status === "approved" ? "#059669" : "#dc2626";
    ...
    const emailResponse = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        subject: `Approval ${decisionLabel} - Asset Replacement Request - ${asset_type}`,
        html: `
              ...
              <div style="background:#ffffff;border:1px solid #e4e4e7;border-radius:24px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.06);">
                ...
                <div style="padding:32px 32px 24px 32px;background:linear-gradient(135deg,#111827 0%,#1f2937 100%);color:#ffffff;">
                  <div style="font-size:11px;letter-spacing:0.24em;text-transform:uppercase;font-weight:700;color:#cbd5e1;">
                    Gjirafa • Approval Outcome
                  </div>
                  <h1 style="margin:14px 0 0 0;font-size:30px;line-height:1.2;font-weight:700;">
                    Replacement Request ${decisionLabel}
                  </h1>
                  <p style="margin:14px 0 0 0;font-size:15px;line-height:1.7;color:#e5e7eb;">
                    The Chief of Growth has completed the approval review for this asset replacement request.
                  </p>
                </div>

                <div style="padding:32px;">
                  <div style="margin-bottom:18px;">
                    <span style="display:inline-block;background:${decisionColor};color:#ffffff;padding:10px 16px;border-radius:999px;font-size:13px;font-weight:700;">
                      ${decisionLabel}
                    </span>
                  </div>
                  ...
                  <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
                    ...
                    <div style="background:#f9fafb;border-radius:18px;padding:16px;">
                      <div style="font-size:11px;font-weight:700;letter-spacing:0.16em;text-transform:uppercase;color:#71717a;">Reviewed By</div>
                      <div style="margin-top:8px;font-size:15px;font-weight:600;color:#111827;">${approved_by || "N/A"}</div>
                    </div>
                  </div>

                  <div style="margin-top:16px;background:#ffffff;border:1px solid #e4e4e7;border-radius:18px;padding:18px;">
                    <div style="font-size:11px;font-weight:700;letter-spacing:0.16em;text-transform:uppercase;color:#71717a;">Approver Notes</div>
                    <div style="margin-top:10px;font-size:15px;line-height:1.8;color:#3f3f46;">
                      ${approver_notes || "No notes provided."}
                    </div>
                  </div>
                ...
                <div style="padding:20px 32px;background:#fafafa;border-top:1px solid #e4e4e7;">
                  <p style="margin:0;font-size:12px;line-height:1.7;color:#71717a;">
                    This approval result was generated automatically by the Asset Issue Reporting System.
                  </p>
                </div>
              </div>
            </div>
